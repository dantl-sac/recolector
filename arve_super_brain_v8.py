...
TRASH_CLASSES = {
    0: ("Bolsa Plastica", "PLASTICO", (0, 255, 0)),
    1: ("Botella", "PLASTICO", (0, 255, 0)),
    2: ("Lata", "METAL", (200, 200, 0)),
    3: ("Papel", "PAPEL", (255, 200, 0)),
    4: ("Colilla", "BASURA", (128, 128, 128)),
    5: ("Pitillo/Sorbete", "PLASTICO", (0, 255, 0)),
    6: ("Vaso Plastico", "PLASTICO", (0, 255, 0)),
    7: ("Carton", "CARTON", (255, 200, 0)),
    8: ("Envoltorio", "PLASTICO", (0, 255, 0)),
    9: ("Recipiente Comida", "PLASTICO", (0, 255, 0)),
    10: ("Tapa Botella", "PLASTICO", (0, 255, 0)),
    11: ("Icopor/Styrofoam", "PLASTICO", (0, 255, 0)),
}

DANGEROUS_CLASSES = set() # Ninguna de las 12 nuevas es peligrosa
